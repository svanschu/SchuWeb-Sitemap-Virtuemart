...
?>
<form action="<?php echo JRoute::_('index.php?option=com_schuweb_sitemap&view=sitemaps');?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="min-width:100px" class="nowrap">
                                    <?php echo JHtml::_('searchtools.sort', 'SCHUWEB_SITEMAP_Heading_Sitemap', 'a.title', $listDirn, $listOrder); ?>
                                </th>
                                <th width="5%">
                                     <?php echo JHtml::_('searchtools.sort', 'SCHUWEB_SITEMAP_Heading_Published', 'a.state', $listDirn, $listOrder); ?>
                                </th>
                                <th width="10%">
                                    <?php echo JHtml::_('searchtools.sort',  'SCHUWEB_SITEMAP_Heading_Access', 'access_level', $listDirn, $listOrder); ?>
                                </th>
                                ...
                                <th width="1%" class="nowrap">
                                    <?php echo JHtml::_('searchtools.sort', 'SCHUWEB_SITEMAP_Heading_ID', 'a.id', $listDirn, $listOrder); ?>
                                 </th>
                            </tr>
                        </thead>
                        <tfoot>
